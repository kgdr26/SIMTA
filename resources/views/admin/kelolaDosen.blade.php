...
<head>
    ...
    <title>SIMTA | Kelola Akun Pengguna</title>
...
<body id="kt_body"
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    <!--begin::Logo-->
                    <a href="{{ route('admin.logout') }}" class="brand-logo">
                        <img alt="Logo" src="pictures/Logo_simta.png" class="w-50" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                        ...
                        <ul class="menu-nav">
                            <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="" class="menu-link">
                                    ...
                                    <span class="menu-text">Kelola Akun Pengguna</span>
                                </a>
                            </li>
                            <li class="menu-item " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span
                                        class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Design\PenAndRuller.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <li class="menu-item menu-item-active" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Kelola Role Dosen</span>
                                </a>
                            </li>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-toolbar">
                                            <button class="btn btn-primary py-2 px-4 font-weight-bolder font-size-m"
                                                ...
                                                onclick="clearForm()">
                                                <i class="flaticon2-plus icon-sm"></i>Buat Role
                                            </button>
                                        </div>
                                    </div>
                                    {{-- end- header  --}}
                                            ...
                                            <table class="table table-head-bg table-hover text-center display nowrap"
                                                ...
                                                <tbody id="dataAkun">
                                                    @foreach ($mahasiswas as $mahasiswa)
                                                        @if ($mahasiswa->dosenPembimbings->count() > 0)
                                                            <tr>
                                                                <td>{{ $loop->iteration }}</td>
                                                                <td>{{ $mahasiswa->user->name }} ({{ $mahasiswa->nim }})
                                                                </td>
                                                                @foreach ($mahasiswa->dosenPembimbings as $dospem)
                                                                    <td>{{ $dospem->dosen->user->name ?? '-' }}</td>
                                                                @endforeach
                                                                <td>
                                                                    <button class="btn btn-warning btn-sm"
                                                                        data-target="#akunUserModal"
                                                                        onclick="editRole({{ $mahasiswa->id }})">Edit</button>
                                                                </td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="modal-content">
                                                        ...
                                                        <div class="p2">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="mahasiswa" id="mahasiswa"
                                                                    class="form-control">
                                                                    <option value="" disabled>Pilih Mahasiswa
                                                                    </option>
                                                                    @foreach ($mahasiswaNotAssigned as $mahasiswa)
                                                                                ...
                                                                                <td>
                                                                                    <select
                                                                                        ...
                                                                                        <option
                                                                                            ...
                                                                                            value="penguji1">Penguji 1
                                                                                        </option>
                                                                                        <option
                                                                                            @if ($i == 3) selected @endif
                                                                                            value="penguji2">Penguji 2
                                                                                        </option>
                                                                                        <option
                                                                                            @if ($i == 4) selected @endif
                                                                                            value="penguji3">Penguji 3
                                                                                        </option>
                                                                                    </select>
                                                                                </td>
                                                                            </tr>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button"
                                                        ...
                                                        onclick="clearForm()" data-dismiss="modal">Close</button>
                                                    @csrf
    ...
    {{-- <script src="assets/js/custom/pages/datatable/datatable.js"></script> --}}

    <script>
        // $('#tambahDosen').click(function() {
        //     var clonedRow = $('#dosenTable tbody tr:first').clone(true);

        //     clonedRow.find('select').each(function() {
        //         $(this).val('');
        //     });
        //     clonedRow.find('select[name="nama_dosen"] option').prop('disabled', false);
        //     $('#dosenTable tbody tr').each(function(index) {
        //         if (index > 0) {
        //             clonedRow.find('select[name="nama_dosen"] option[value="' + $(this).find(
        //                 'select[name="nama_dosen"]').val() + '"]').prop('disabled', true);
        //         }
        //     });

        //     // Append the cloned row to the table body
        //     $('#dosenTable tbody').append(clonedRow);
        // });

        // $('#deleteDosen').click(function() {
        //     if ($('#dosenTable tbody tr').length > 1) {
    ...
    <script>
        $(function() {
            var id = null; // Initialize id variable
            ...
            $('#submit').click(function() {
                ...
                $('#dosenTable tbody tr').each(function() {
                    dosenData.push({
                        dosen_id: $(this).find(`select[name="nama_dosen_${i}"]`).val(),
                        tipe: $(this).find(`select[name="tipe_dosen_${i}"]`).val()
                    });
                    i++;
                });

                var url = '{{ route('admin.storeRoleDosen') }}';
                var type = 'POST';

                if (id !== null) {
                    url = '{{ route('admin.updateRoleDosen', '') }}/' + id;
                    type = 'PUT';
                }
        ...
        // Fungsi untuk memuat data ke dalam modal saat tombol "Edit" diklik
        function editRole(id) {
            $.ajax({
                url: '{{ route('admin.editRoleDosen', '') }}/' + id, // Ganti URL dengan endpoint yang sesuai
                type: 'GET',
                dataType: 'json',
                success: function(response) {

                    var mahasiswa = response.mahasiswa;
                    var mahasiswaName = mahasiswa.user ? mahasiswa.user.name : "Unknown";
                    var namaMahasiswa = mahasiswaName + ' (' + mahasiswa.nim + ')';

                    // Append Mahasiswa's name and NIM to the modal
                    $('#mahasiswa').empty().append($('<option>').text(namaMahasiswa).attr('value', mahasiswa.id)
                        .prop('selected', true))
                    // Populate the dosen and tipe values
                    $.each(response.mahasiswa.dosen_pembimbings, function(index, dosenPembimbing) {
                        var dosenIndex;
                        switch (dosenPembimbing.tipe) {
                            case 'pembimbing1':
                                dosenIndex = 0;
                                break;
                            case 'pembimbing2':
                        ...
                        $(`#namaDosen_${dosenIndex}`).val(dosenPembimbing.id_dosen || '');
                        $(`#tipeDosen_${dosenIndex}`).val(dosenPembimbing.tipe);
                    });

                    $('#akunUserModalLabel').text('Edit Role');
                    // $('#submit').hide();
                    // $('#update').show();
        ...
        function clearForm() {
            ...
            $('#dosenTable tbody tr').each(function(index) {
                $(this).find(`select[name="nama_dosen_${index}"]`).val('');
                $(this).find(`select[name="tipe_dosen_${index}"]`).val(['pembimbing1', 'pembimbing2', 'penguji1',
                    'penguji2', 'penguji3'
                ][index]);
            });
            $('#submit').show();

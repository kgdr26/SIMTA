...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>SIMTA | Nazwa Aiya Divani</title>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px" aria-expanded="false">
                                        <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                                            ...
                                            <span id="user_acc" class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Auth::user()->username }}</span>
                                        </div>
                                    </div>
                            </div>
                            <!--end::User-->

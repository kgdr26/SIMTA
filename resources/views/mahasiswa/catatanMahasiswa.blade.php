                                                ...
                                                <tbody id="dataLog">
                                                    @foreach ($log as $l)
                                                        <tr>
                                                            ...
                                                            <td>{{ $l->dosen->user->name }} ({{ $l->dosen->nip }})</td>
                                                            <td>{{ $l->tanggal_bimbingan }}</td>
                                                            <td>{{ $l->catatan_bimbingan }}</td>
                                                            <td>{{ $l->action_plan }}</td>
                                                            <td>
                                                                @if ($l->status == 0)
                                                                    <span class="label label-lg label-light-danger label-inline">Submitted</span>
                                                                @elseif ($l->status == 1)
                                            ...
                                            <div class="modal-content">
                                                        ...
                                                        <div class="p2">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="dosen" id="dosen" class="form-control">
                                                                    ...
                                                                    @foreach ($dosen as $d)
                                                                        <option value="{{ $d->id }}">{{ $d->user->name }} ({{ $d->nip }})</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="tgl_bimbingan" id="kt_datepicker_4_1" class="form-label">Tanggal Bimbingan <span class="text-danger">*</span></label>
                                                                <div class="input-group date" id="tanggal_bimbingan">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button"
                                                        ...
                                                        @csrf
                                                    <button type="submit" class="btn btn-primary font-weight-bold" id="submit">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(function(param) {
            $('#submit').click(function(){
                var dosen = $('#dosen').val();
                var tanggal_bimbingan = $('#tanggal_bimbingan input').val();
                var catatan_bimbingan = $('#catatan_bimbingan').val();
                var action_plan = $('#action_plan').val();

                if(dosen == '' || tanggal_bimbingan == '' || catatan_bimbingan == '' || action_plan == ''){
                    alert('Data tidak boleh kosong');
                }else{
                    $.ajax({
                        url: "{{ route('mahasiswa.storeLogBimbingan') }}",
                        type: "POST",
                        data: {
                            dosen: dosen,

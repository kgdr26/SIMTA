...
var KTWidgets = function () {
    ...
    var _initChartsWidget1 = function () {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['Amanah', 'Kompeten', 'Harmonis', 'Loyal', 'Adaptif', 'Kolaboratif'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    // Charts widgets
    var _initChartsWidgetRekan = function () {
        var element = document.getElementById("kt_charts_widget_rekan_chart");
	...
	var _initMixedWidgetRekan = function () {
        var element = document.getElementById("kt_mixed_widget_rekan_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
